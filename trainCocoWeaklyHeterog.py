...
from LogicLossVOC.WeakLabelLogicLossCOCO import calculateLogicLoss, domainlossCOCO,calculateLogicLossHeterogeneous
...
if debug:
    ...
    dir_weaklabel = Path('../../datasetCOCO/enhancedAnnotationsTestApril3/')
...
def train_model(
    ...
    dataset = CombinedDatasetCLEVR(dir_img, dir_weaklabel,dir_mask,img_scale,"COCO")
        ...
        for epoch in range(1, epochs + 1):
            ...
            for batch in train_loader:
                ...
                with torch.autocast(device.type if device.type != 'mps' else 'cpu', enabled=amp):
                    ...
                    loss += 0.05*calculateLogicLossHeterogeneous(masks_pred,weaklabel,configuration_dict,batch_id)
            ...
            if True: #epoch%3 == 0:
                ...
                train_score,train_score_shape = evaluateFullySupervisedCOCOwPrecisionRecall(model,train_loader,device,amp,-1000,1000)
